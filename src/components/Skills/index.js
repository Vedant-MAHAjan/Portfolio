...
// import { faA } from '@fortawesome/free-brands-svg-icons';
...
// Hardcoded data with favicon URLs
const hardcodedSkills = [
  {      
    ...
    skills: [
      ...
      // Add other skills with favicon URLs
    ],
  },
];
            ...
            <Skill key={skill.title}>
              ...
              <SkillList>
                {skill.skills.map((item, index) => (
                  <SkillItem key={index}>
                    <SkillIcon icon={item.icon} className="skill-icon" />
